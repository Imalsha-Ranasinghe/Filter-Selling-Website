      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 flex items-center justify-center p-4">
        <div className="w-full max-w-6xl bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="hidden md:block md:w-1/2 relative">
            <img 
              src='https://media.istockphoto.com/id/1451088545/photo/purified-water-pouring-in-drinking-glass-on-rock-at-forest.jpg?s=612x612&w=0&k=20&c=fjxbCDLJXz3LYx_iiRUUuJi28EuN3bE97qN4ixsWB4o='
              alt="Pure water"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-8">
              <div className="text-white">
                <h2 className="text-2xl font-bold mb-2">Pure Hydration</h2>
                <p className="opacity-90">Your gateway to clean water solutions</p>
              </div>
            </div>
          </div>
