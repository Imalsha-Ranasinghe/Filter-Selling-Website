            ...
            <div className="flex items-center space-x-6 ml-8">
              ...
              {isLoggedIn && (
                <button className="relative p-2 rounded-lg hover:bg-gray-50">
                  ...
                  <span className="absolute -top-1 -right-1 bg-teal-500 text-white text-xs px-2 rounded-full">
                    3
                  </span>
                </button>
              )}
              ...
              {!isLoggedIn && (
                <Link
                  to="/signup"
                  className="bg-gradient-to-r from-indigo-600 to-teal-500 text-white px-6 py-2 rounded-lg hover:opacity-90 transition-opacity"
                >
                  Get Started
                </Link>
              )}
